...
.factory('Phone', function($ionicPlatform, $translate) {
  ...
  var mobile_langchoice = 'Choose country';

  $ionicPlatform.ready(function() {
    $translate(['mobile_langchoice'])
    .then(function(res) {
      mobile_langchoice = res.mobile_langchoice;
    });
  });
